...
echo ================================================================
powershell -NoProfile -Command "$ErrorActionPreference='Continue'; & '.\venv\Scripts\python.exe' -u code\%~2 2>&1 | ForEach-Object { [string]$_ } | Tee-Object -FilePath '%LOG%' -Append"
goto :eof
